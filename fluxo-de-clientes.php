                        ...
                        <tr class="small">
                            <th colspan="9" class="small">
                                <div class="ui left floated small primary labeled icon button bck-azul-escuro-daju">
                                    <i class="user icon bck-azul-escuro-daju"></i>Fluxo de clientes
                                </div>
                            </th>
                        </tr>
                        <tr>
                    ...
                    <tbody>
                        <?php
                            ...
                            if(isset($_POST['dataP1']) || isset($_POST['dataP2'])){
                                $sql = "SELECT * FROM `fluxo_de_clientes` WHERE `dt_base` BETWEEN '".$data_p1."' AND '".$data_p2."'";
                            }else{
                                $sql = "SELECT * FROM `fluxo_de_clientes`";
                            }
                            ...
                            foreach($conexaoLoja AS $linha_consulta_loja){
                                echo "<tr>";
                                    ...
                                    echo "<td>".$linha_consulta_loja['fluxo_de_clientes']."</dh>";
                                echo "</tr>";
                            }
                        ?>
                    </tbody>
