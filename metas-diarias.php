                ...
                <table class="ui selectable celled table pink text-center">
                        ...
                        <tr class="small">
                            <th colspan="9" class="small">
                                <div class="ui left floated small primary labeled icon button bck-azul-escuro-daju">
                                    <i class="shopping bag icon bck-azul-escuro-daju"></i>Metas Diárias
                                </div>
                            </th>
                        </tr>
                        <tr>
                    ...
                    <tbody>
                        <?php
                            ...
                            if(isset($_POST['data_P1']) || isset($_POST['data_P2'])){
                                $sql = "SELECT * FROM `metas_diarias` WHERE `dt_meta` BETWEEN '".$data_p1."' AND '".$data_p2."'";
                            }else{
                                $sql = "SELECT * FROM `metas_diarias`";
                            }
                            ...
                            foreach($conexaoLoja AS $linha_consulta_loja){
                                echo "<tr>";
                                    ...
                                    echo "<td>".date('d/m/Y', strtotime($linha_consulta_loja['dt_meta']))."</dh>";
                                    echo "<td>".$linha_consulta_loja['peso_hiper_dia']."</dh>";
                                    echo "<td>R$ ".number_format($linha_consulta_loja['minima'],2,',','.')."</dh>";
                                    echo "<td>R$ ".number_format($linha_consulta_loja['meta'],2,',','.')."</dh>";
                                    echo "<td>R$ ".number_format($linha_consulta_loja['super'],2,',','.')."</dh>";
                                    echo "<td>R$ ".number_format($linha_consulta_loja['hiper'],2,',','.')."</dh>";
                                    echo "<td>R$ ".number_format($linha_consulta_loja['mega'],2,',','.')."</dh>";
                                echo "</tr>";
                            }
                        ?>
                    </tbody>
